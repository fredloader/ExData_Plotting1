...
plot(x, dataplot$Sub_metering_1, type = "l", xlab = " ", ylab = "Energy sub metering")
lines(x, dataplot$Sub_metering_2, type = "l", col = "red")
lines(x, dataplot$Sub_metering_3, type = "l", col = "blue")
